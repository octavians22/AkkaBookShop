...
public class KafkaConsumerConfig {
		...
		public ConsumerFactory<String, Object> consumerFactory() {
				...
				props.put(ConsumerConfig.GROUP_ID_CONFIG, "book-ordered-group");
		...
		@Bean
		public ConsumerFactory<String, List<UserOrderDTO>> consumerFactoryOrderedBook() {
				Map<String, Object> config = new HashMap<>();
				config.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
				config.put(ConsumerConfig.GROUP_ID_CONFIG, "book-ordered-group");
		...
		@Bean
		public ConcurrentKafkaListenerContainerFactory<String, List<UserOrderDTO>> kafkaListenerContainerFactoryOrderedBook() {
				ConcurrentKafkaListenerContainerFactory<String, List<UserOrderDTO>> factory =
								new ConcurrentKafkaListenerContainerFactory<>();
				factory.setConsumerFactory(consumerFactoryOrderedBook());
				return factory;
		}
}
